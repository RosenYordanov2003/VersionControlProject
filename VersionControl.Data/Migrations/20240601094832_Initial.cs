        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PullRequests_AspNetUsers_SenderId",
                        column: x => x.SenderId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "UserRepositoryContributors",
                columns: table => new
                {
                    UserId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    RepositoryId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserRepositoryContributors", x => new { x.UserId, x.RepositoryId });
                    table.ForeignKey(
                        name: "FK_UserRepositoryContributors_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_UserRepositoryContributors_Repositories_RepositoryId",
                        column: x => x.RepositoryId,
                        principalTable: "Repositories",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ModificationType = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FileDifferences", x => x.Id);
                    table.ForeignKey(
                        name: "FK_FileDifferences_Modifications_ModificationId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FileDifferences_ModificationId",
                table: "FileDifferences",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserRepositoryContributors_RepositoryId",
                table: "UserRepositoryContributors",
                column: "RepositoryId");
        }
